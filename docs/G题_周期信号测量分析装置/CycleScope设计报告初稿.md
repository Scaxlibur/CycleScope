...
>
> 归档说明（2026-08-02）：其中 main@94dab8f-dirty、未握手和仅电脑模拟器的表述是历史快照，已被后续真实两板、最终标定和 M12/M8M9 证据覆盖。当前结论请看[验收证据索引](../验收证据索引.md)、[测试与证据索引](../测试与证据索引.md)与[最终报告](../../final_doc/设计报告.md)；本文后续的旧状态叙述不作逐段更新。
>
