...
| 证据根 | 已验证范围 | 原始归档位置 |
|---|---|---|
| M10 LAN 自检 | 采集、时序、DMA、故障注入和真实 ADC LAN 基线。 | tool-of-rei/evidence/m10-lan-selftest-20260731/ |
| M8 LAN 长稳 | 10,001 帧真实 ADC、120,012 个 WAVE 包、UDP checksum、零 IP 分片与连续性。 | tool-of-rei/evidence/m8-lan-longrun-20260731/ |
| M11 真实前端 | AD8065/AD9226、FIR、动态范围、频响、干扰、组合波和 J 长稳。 | tool-of-rei/evidence/m11-real-frontend-20260731/ |
| ADC 直连 | AD9226 位序、raw-IOB 相位、ORA 和码域基础证据。 | tool-of-rei/evidence/adc-direct-wire-20260731/ |
| M12 双目的地 UDP | P4 主链与电脑被动镜像，100/1,000 帧逐字节载荷对照。 | tool-of-rei/evidence/m12-dual-destination-20260801/ |
| M14 QSPI 固化 | fpga-v1.0.0@038e981 的 PS+PL 写入与掉电冷启动。 | tool-of-rei/evidence/m14-qspi-persistent-20260801/ |
