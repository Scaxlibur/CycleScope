...
本工作树现保留来自 FPGA 冻结基线的 124 个点级回放根。原有 115 个共同点除 README 外逐字节一致；本次补齐 9 个 4/5/7.2/7.5/10 MHz、高频边界、长稳和 100 kHz 点。每个点仍保留 manifest 与 SHA256SUMS；新增或重放前均须在隔离网络检查目标接口和限速。
