...
来自 fpga-v1.0.0@038e981 的原始档案已按原目录名并列复制到本目录：M8 LAN 长稳、M10 LAN 自检、M11 真实前端、ADC 直连、M12 双目的地 UDP、M14 QSPI 固化，以及 ADC/SPI 历史诊断根。它们与主线 P4 标定根没有同名目录冲突。

FPGA 档案总量约 1.2 GB；其原文分类说明见 ../fpga-history/evidence-README.md，面向合并后的索引见 ../../docs/FPGA验收证据索引.md。M11 主根的 346 份内部 SHA256SUMS 已在本次复制后复核通过。不要把 M11 的历史 calibration-v1 写成 P4 当前 C5DCDE41 频响资产。
