if(CONFIG_CYCLESCOPE_CSLP_DIAGNOSTIC_CONSUMER)
    message(FATAL_ERROR
        "display fault tests cannot run with the CSLP diagnostic consumer")
endif()

if(CONFIG_CYCLESCOPE_CSLP_DISABLE_PUSH_TEST)
    message(FATAL_ERROR
        "display fault tests cannot run with the DISABLE/CONFIG/ENABLE test")
endif()
...
target_compile_definitions(
    ${COMPONENT_LIB}
    PRIVATE
        CONFIG_CYCLESCOPE_DISPLAY_STARTUP_FAULT_TEST=1
)
