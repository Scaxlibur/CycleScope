...
夹具源码和本 README 受版本控制；__pycache__、构建缓存、串口日志、pcap 和临时输出仍保持忽略。原始数据的位置与适用范围见 [../../docs/测试与证据索引.md](../../docs/测试与证据索引.md)。
...
3. 达到可引用结论后，在 [../../docs/测试与证据索引.md](../../docs/测试与证据索引.md) 和 [../项目快照.md](../项目快照.md) 中补充证据根、哈希和适用范围。
